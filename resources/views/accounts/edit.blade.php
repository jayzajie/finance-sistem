...
@section('content')
<div>
    <h1 class="page-title">Edit Rekening</h1>
    <p class="page-subtitle">Halaman untuk mengedit rekening</p>

    <div class="table-container">
        <div class="table-header">
            <h2 class="table-title">Form Edit Rekening</h2>
                ...
                <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 24px;">
                    ...
                    <div>
                        ...
                        <select name="account_type" required 
                            ...
                            <option value="cash" {{ old('account_type', $account->account_type) == 'cash' ? 'selected' : '' }}>Cash (Tunai)</option>
                    ...
                    <div>
                        <label style="display: block; font-size: 14px; font-weight: 500; color: #4a5568; margin-bottom: 8px;">
                            Saldo <span style="color: #e53e3e;">*</span>
                        </label>
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3"
                            ...
                            onfocus="this.style.borderColor='#6366f1'; this.style.boxShadow='0 0 0 3px rgba(99, 102, 241, 0.1)'"
                            onblur="this.style.borderColor='#e2e8f0'; this.style.boxShadow='none'">{{ old('description', $account->description) }}</textarea>
                        @error('description')
                            <span style="color: #e53e3e; font-size: 12px;">{{ $message }}</span>
                        @enderror
                    </div>
