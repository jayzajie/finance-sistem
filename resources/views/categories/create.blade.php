...
<div>
    ...
    <p class="page-subtitle">Halaman untuk menambah kategori baru</p>

    <div class="table-container">
        <div class="table-header">
            <h2 class="table-title">Form Tambah Kategori</h2>
                ...
                <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 24px;">
                    <div>
                        ...
                        <input type="text" name="name" required 
                            ...
                            value="{{ old('name') }}"
                            placeholder="Contoh: Gaji, Listrik, Penjualan"
                    ...
                    <div>
                        ...
                        <input type="text" name="sub_category" 
                            ...
                            placeholder="Contoh: Kas Kecil, Kas Besar"
                            onfocus="this.style.borderColor='#6366f1'; this.style.boxShadow='0 0 0 3px rgba(99, 102, 241, 0.1)'"
                            onblur="this.style.borderColor='#e2e8f0'; this.style.boxShadow='none'">
                        @error('sub_category')
                            <span style="color: #e53e3e; font-size: 12px;">{{ $message }}</span>
                    ...
                    <div>
                        ...
                        <select name="type" required 
                            ...
                            <option value="income" {{ old('type') == 'income' ? 'selected' : '' }}>Kas Masuk (Pendapatan)</option>
                            <option value="expense" {{ old('type') == 'expense' ? 'selected' : '' }}>Kas Keluar (Biaya)</option>
                        </select>
                        @error('type')
                            <span style="color: #e53e3e; font-size: 12px;">{{ $message }}</span>
                        @enderror
