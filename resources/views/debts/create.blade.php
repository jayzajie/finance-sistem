...
@section('content')
<div>
    <h1 class="page-title">Tambah Hutang/Piutang</h1>
    <p class="page-subtitle">Halaman untuk menambah data hutang atau piutang</p>

    <div class="table-container">
        <div class="table-header">
            <h2 class="table-title">Form Tambah Hutang/Piutang</h2>
                ...
                <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 24px;">
                    <div>
                        ...
                        <select name="type" required 
                            ...
                            <option value="debt" {{ old('type', request('type')) == 'debt' ? 'selected' : '' }}>Hutang</option>
                            <option value="receivable" {{ old('type', request('type')) == 'receivable' ? 'selected' : '' }}>Piutang</option>
                        </select>
                        @error('type')
                    ...
                    <div>
                        ...
                        <input type="text" name="party_name" required 
                            ...
                            placeholder="Nama pemberi hutang atau penerima piutang"
                            onfocus="this.style.borderColor='#6366f1'; this.style.boxShadow='0 0 0 3px rgba(99, 102, 241, 0.1)'"
                            onblur="this.style.borderColor='#e2e8f0'; this.style.boxShadow='none'">
                        @error('party_name')
                            <span style="color: #e53e3e; font-size: 12px;">{{ $message }}</span>
                    ...
                    <div style="grid-column: 1 / -1;">
                        ...
                        <textarea name="description" rows="3"
                            ...
                            placeholder="Deskripsi hutang/piutang (opsional)"
                            onfocus="this.style.borderColor='#6366f1'; this.style.boxShadow='0 0 0 3px rgba(99, 102, 241, 0.1)'"
