...
@section('content')
<div>
    <h1 class="page-title">Data Kas Masuk</h1>
    <p class="page-subtitle">Halaman untuk mengelola dan menambahkan kas masuk</p>

    <div class="table-container">
        <div class="table-header">
            <h2 class="table-title">Transaksi Kas Masuk</h2>
            <div style="display: flex; gap: 12px;">
                <a href="{{ route('transactions.create') }}?type=income" class="btn btn-primary">
                ...
                <input type="text" placeholder="Cari Data Kas Masuk" style="padding: 10px 16px; border: 1px solid #e2e8f0; border-radius: 10px; font-size: 14px;">
            </div>
        </div>
        ...
        <div style="padding: 20px 24px; background: #f7fafc; border-bottom: 1px solid #e2e8f0;">
            ...
            <div style="font-size: 24px; font-weight: 700; color: #1a202c;">Rp. {{ number_format($totalIncome, 0, ',', '.') }}</div>
        </div>
